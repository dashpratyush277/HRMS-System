...
const KpiIcon = ({ name }) => {
  const paths = {
    ...
    salary:   <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z" />,
    rejected: <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M18.364 18.364A9 9 0 005.636 5.636m12.728 12.728A9 9 0 015.636 5.636m12.728 12.728L5.636 5.636" />,
...
const KpiCard = ({ title, value, iconName, colorClass, loading }) => (
  <div className={`neon-card p-5 rounded-2xl group cursor-default`}>
...
/* ── Quick action button ─────────────────────────────────────────────────── */
const QuickAction = ({ label, desc, path, navigate }) => (
  <button
...
const AdminDashboard = () => {
  ...
  const kpis = [
    ...
    { title: "Rejected Leaves",  value: lv("rejectedLeaves"),  iconName: "rejected", colorClass: "icon-red"    },
    ...
    { title: "Total Net Salary", value: fmtCurrency("totalNetSalary"), iconName: "salary", colorClass: "icon-purple" },
  ];
      ...
      <div className="relative overflow-hidden bg-slate-900/50 backdrop-blur-xl border border-slate-800/80
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            ...
            <p className="text-slate-400 text-sm mt-1.5">Here&apos;s what&apos;s happening with your organisation today.</p>
          </div>
          {/* Date card + refresh */}
        ...
        <div className="lg:col-span-2 bg-slate-900/50 backdrop-blur-xl border border-slate-800/80 rounded-2xl p-5">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            {[
              ...
              { label: "Departments",     desc: "Manage department structure",   path: "/departments"     },
              ...
              { label: "Leave Balance",   desc: "Manage employee leave balance", path: "/leaves/balance"  },
            ].map((a) => <QuickAction key={a.label} {...a} navigate={navigate} />)}
          </div>
        </div>
        ...
        <div className="bg-slate-900/50 backdrop-blur-xl border border-slate-800/80 rounded-2xl p-5">
          ...
          <div className="space-y-3">
            {[
              ...
              { label: "Role",         value: user?.role, pill: "bg-red-500/15 text-red-400 border border-red-500/30" },
              { label: "Today",        value: dateStr },
